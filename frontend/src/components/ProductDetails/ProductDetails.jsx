                            ...
                            <div className="flex-1 py-2 px-3">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    <div className="flex gap-8 mt-2 items-center text-sm">
                                        <span className="px-2 py-1 border rounded text-gray-700 font-medium">{product.brand?.name}</span>
                                        {product.warranty > 0 && <span>{product.warranty} Year Warranty</span>}
                                    </div>
                                    {/* <!-- warranty & brand --> */}
