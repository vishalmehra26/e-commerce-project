        ...
        <div className="hidden sm:flex flex-col gap-4 w-1/4 px-1">
            ...
            <div className="flex flex-col bg-white rounded-sm shadow">
                ...
                <div className="flex flex-col pb-3 border-b text-sm">
                    ...
                    <span className="p-3 pl-14 text-gray-400 cursor-not-allowed">Manage Addresses</span>
                    <span className="p-3 pl-14 text-gray-400 cursor-not-allowed">PAN Card Information</span>
                </div>
                {/* <!-- account settings tab --> */}
                ...
                <div className="flex flex-col pb-3 border-b text-sm">
                    <span className="p-3 pl-14 text-gray-400 cursor-not-allowed flex justify-between pr-6">Gift Cards <span className="font-medium text-gray-400">₹0</span></span>
                    <span className="p-3 pl-14 text-gray-400 cursor-not-allowed">Saved UPI</span>
                    <span className="p-3 pl-14 text-gray-400 cursor-not-allowed">Saved Cards</span>
                </div>
                {/* <!-- payments tab --> */}
                ...
                <div className="flex items-center gap-5 px-4 py-4 border-b">
                    ...
                    <span className="flex w-full justify-between font-medium text-gray-400 cursor-not-allowed">
                        MY CHATS
                        <span><ChevronRightIcon /></span>
                    </span>
                </div>
                ...
                <div className="flex flex-col pb-3 border-b text-sm">
                    <span className="p-3 pl-14 text-gray-400 cursor-not-allowed">My Coupons</span>
                    <span className="p-3 pl-14 text-gray-400 cursor-not-allowed">My Reviews & Ratings</span>
                    <span className="p-3 pl-14 text-gray-400 cursor-not-allowed">All Notifications</span>
